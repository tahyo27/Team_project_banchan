...
ALTER TABLE "ADDRESSBOOK" ADD CONSTRAINT "PK_ADDRESSBOOK" PRIMARY KEY ("NUM");
...
ALTER TABLE "ADDRESSBOOK" ADD CONSTRAINT "FK_MEMBER_TO_ADDRESSBOOK_1" FOREIGN KEY ("MEMBER_NUM") REFERENCES "MEMBER" ("NUM");
ALTER TABLE "ORDER" ADD CONSTRAINT "FK_MEMBER_TO_ORDER_1" FOREIGN KEY ("MEMBER_NUM") REFERENCES "MEMBER" ("NUM");
...
-- CHECK --
ALTER TABLE "ADDRESSBOOK" ADD CONSTRAINT "CHK_ADDRESSBOOK_SBASE" CHECK ("SBASE" IN (0, 1));
